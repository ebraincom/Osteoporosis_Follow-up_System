            ...
            <div v-if="selectedPatient.historyRecords && selectedPatient.historyRecords.length > 0" class="history-list">
              ...
              >
                ...
                <div class="history-actions">
                  <el-button type="text" size="small" @click.stop="viewHistoryDetail(record)">
                    查看详情
                  </el-button>
                </div>
              </div>
        ...
        <div class="followup-result" v-if="selectedHistoryRecord.result">
          ...
          <el-descriptions :column="2" border>
            <el-descriptions-item label="患者状态">
              {{ selectedHistoryRecord.result.status }}
            </el-descriptions-item>
...
const submitFollowup = async () => {
  ...
  try {
    ...
    const followupData = {
      ...
      time: `${followupYear.value}-${followupMonth.value.padStart(2, '0')}-${followupDay.value.padStart(2, '0')}T${followupTime.value}:00`,
