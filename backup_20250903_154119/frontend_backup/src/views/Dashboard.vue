         ...
         >
           ...
           <template v-if="isDataCollectionActive">
             ...
             <el-menu-item index="/dashboard/data-collection/voice">
               ...
               <template #title>语音自述</template>
             </el-menu-item>

             <el-menu-item index="/dashboard/data-collection/diet">
               <el-icon><Picture /></el-icon>
               <template #title>饮食AI识别</template>
             </el-menu-item>
           </template>
...
const isFollowupActive = computed(() => route.path.startsWith('/dashboard/followup'))
